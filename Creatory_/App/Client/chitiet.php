                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-5">
                        <div class="card-body">
                            ...
                            <p class="card-text mt-3"><b>Link google drive:</b>  </br><a href="<?php echo $row['link']; ?>"><i class="fa-solid fa-download"></i>tải xuống</a></p>
...
<?php
        ...
        <div class="container">
            ...
            <div class="row mt-5"></div>
            <div class="row mt-5"></div>
            <h1 class = "text-center">Template đã bị xóa hoặc không tồn tại</h1>
